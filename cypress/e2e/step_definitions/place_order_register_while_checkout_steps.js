...
Given("I navigate to url_place_order_register_while_checkout", () => {
  homePage.visit();
});
...
When("I click Cart button_place_order_register_while_checkout", () => {
  homePage.clickCart();
});
...
When("I click Register Login button_place_order_register_while_checkout", () => {
...
When("I click Proceed To Checkout button_place_order_register_while_checkout", () => {
  cartPage.clickProceedToCheckout();
});
...
When("I enter payment details_place_order_register_while_checkout", () => {
...
When("I click Pay and Confirm Order button_place_order_register_while_checkout", () => {
